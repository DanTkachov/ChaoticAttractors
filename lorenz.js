...
function animate_lorenz() {
    ...
    for(let i = 0; i < NUM_SPHERES; i++){
        cubes[i].position.x += speed*(10.0 * (cubes[i].position.y - cubes[i].position.x));
        cubes[i].position.y += speed*(cubes[i].position.x * (30.0 - cubes[i].position.z) - cubes[i].position.y);
        cubes[i].position.z += speed*(cubes[i].position.x * cubes[i].position.y - (8/3) * cubes[i].position.z);
    }
